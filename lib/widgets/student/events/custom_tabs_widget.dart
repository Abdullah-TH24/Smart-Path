...
import 'package:smartpath/widgets/student/events/custom_button_for_all_widget.dart';
import 'package:smartpath/widgets/student/events/custom_button_for_any_widget.dart';
      ...
      child: Padding(
        ...
        child: Row(
          children: List.generate(
            controller.allReactions!.length + 1,
            (index) =>
                (index == 0)
